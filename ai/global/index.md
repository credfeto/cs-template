...
| [packages.instructions.md](packages.instructions.md) | Secure versions, managed vs native, deprecated packages, human approval required for non-credfeto/funfair-tech packages, with an exception when a pre-commit component tool mandates the specific package change |
