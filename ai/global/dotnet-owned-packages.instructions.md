...
| `FunFair.CodeAnalysis` | [funfair-server-code-analysis](https://github.com/funfair-tech/funfair-server-code-analysis) | Roslyn code analysis rules for FunFair projects (diagnostics use the `FFS####` prefix) |
