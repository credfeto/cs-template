...
The `FunFair.Test.*` packages in this file are owned by the organisation — see [dotnet-owned-packages.instructions.md](dotnet-owned-packages.instructions.md) for the GitHub source repository.
...
The `FunFair.Test.*` packages in this section are org-owned — see [dotnet-owned-packages.instructions.md](dotnet-owned-packages.instructions.md) for their GitHub source repositories.
...
FFS rules in this section are enforced by the `FunFair.CodeAnalysis` package — see [dotnet-owned-packages.instructions.md](dotnet-owned-packages.instructions.md) for the GitHub source repository.
