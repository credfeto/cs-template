...
- In .NET repositories, write benchmarks as xUnit tests in the benchmark test project, using `FunFair.Test.Common` to invoke the BenchmarkDotNet entry points and assert the measured thresholds.
